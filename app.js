...
void main() {
	...
	`}function Gx(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){let c=a.mapping,l=c===ac||c===cc,h=c===Ss||c===bs;if(l||h){let u=e.get(a),d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new vr(s)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{let f=a.image;return l&&f&&f.height>0||h&&f&&i(f)?(t===null&&(t=new vr(s)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function i(a){let c=0,l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){let c=a.target;c.removeEventListener("dispose",r);let l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Wx(s){let e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let i=t(n);return i===null&&tr("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Xx(s,e,t,n){let i={},r=new WeakMap;function o(u){let d=u.target;d.index!==null&&e.remove(d.index);for(let m in d.attributes)e.remove(d.attributes[m]);d.removeEventListener("dispose",o),delete i[d.id];let f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,t.memory.geometries++),d}function c(u){let d=u.attributes;for(let f in d)e.update(d[f],s.ARRAY_BUFFER)}function l(u){let d=[],f=u.index,m=u.attributes.position,_=0;if(f!==null){let T=f.array;_=f.version;for(let y=0,x=T.length;y<x;y+=3){let R=T[y+0],w=T[y+1],P=T[y+2];d.push(R,w,w,P,P,R)}}else if(m!==void 0){let T=m.array;_=m.version;for(let y=0,x=T.length/3-1;y<x;y+=3){let R=y+0,w=y+1,P=y+2;d.push(R,w,w,P,P,R)}}else return;let g=new(Nh(d)?eo:Qr)(d,1);g.version=_;let p=r.get(u);p&&e.remove(p),r.set(u,g)}function h(u){let d=r.get(u);if(d){let f=u.index;f!==null&&d.version<f.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function qx(s,e,t){let n;function i(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function c(d,f){s.drawElements(n,f,r,d*o),t.update(f,n,1)}function l(d,f,m){m!==0&&(s.drawElementsInstanced(n,f,r,d*o,m),t.update(f,n,m))}function h(d,f,m){if(m===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,m);let g=0;for(let p=0;p<m;p++)g+=f[p];t.update(g,n,1)}function u(d,f,m,_){if(m===0)return;let g=e.get("WEBGL_multi_draw");if(g===null)for(let p=0;p<d.length;p++)l(d[p]/o,f[p],_[p]);else{g.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,m);let p=0;for(let T=0;T<m;T++)p+=f[T]*_[T];t.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Yx(s){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Kx(s,e,t){let n=new WeakMap,i=new ft;function r(o,a,c){let l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0,d=n.get(a);if(d===void 0||d.count!==u){let b=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",b)};d!==void 0&&d.texture.dispose();let f=a.morphAttributes.position!==void 0,m=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,g=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],T=a.morphAttributes.color||[],y=0;f===!0&&(y=1),m===!0&&(y=2),_===!0&&(y=3);let x=a.attributes.position.count*y,R=1;x>e.maxTextureSize&&(R=Math.ceil(x/e.maxTextureSize),x=e.maxTextureSize);let w=new Float32Array(x*R*4*u),P=new $r(w,x,R,u);P.type=Cn,P.needsUpdate=!0;let I=y*4;for(let M=0;M<u;M++){let L=g[M],H=p[M],X=T[M],$=x*R*4*M;for(let Z=0;Z<L.count;Z++){let B=Z*I;f===!0&&(i.fromBufferAttribute(L,Z),w[$+B+0]=i.x,w[$+B+1]=i.y,w[$+B+2]=i.z,w[$+B+3]=0),m===!0&&(i.fromBufferAttribute(H,Z),w[$+B+4]=i.x,w[$+B+5]=i.y,w[$+B+6]=i.z,w[$+B+7]=0),_===!0&&(i.fromBufferAttribute(X,Z),w[$+B+8]=i.x,w[$+B+9]=i.y,w[$+B+10]=i.z,w[$+B+11]=X.itemSize===4?i.w:1)}}d={count:u,texture:P,size:new ye(x,R)},n.set(a,d),a.addEventListener("dispose",b)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let f=0;for(let _=0;_<l.length;_++)f+=l[_];let m=a.morphTargetsRelative?1:1-f;c.getUniforms().setValue(s,"morphTargetBaseInfluence",m),c.getUniforms().setValue(s,"morphTargetInfluences",l)}c.getUniforms().setValue(s,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function Zx(s,e,t,n){let i=new WeakMap;function r(c){let l=n.render.frame,h=c.geometry,u=e.get(c,h);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),i.get(c)!==l&&(t.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){let d=c.skeleton;i.get(d)!==l&&(d.update(),i.set(d,l))}return u}function o(){i=new WeakMap}function a(c){let l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:o}}var dp=new Wt,Kf=new lo(1,1),fp=new $r,pp=new La,mp=new no,Zf=[],Jf=[],$f=new Float32Array(16),jf=new Float32Array(9),Qf=new Float32Array(4);function Mr(s,e,t){let n=s[0];if(n<=0||n>0)return s;let i=e*t,r=Zf[i];if(r===void 0&&(r=new Float32Array(i),Zf[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function Xt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function qt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function $c(s,e){let t=Jf[e];t===void 0&&(t=new Int32Array(e),Jf[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function Jx(s,e){let t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function $x(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Xt(t,e))return;s.uniform2fv(this.addr,e),qt(t,e)}}function jx(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Xt(t,e))return;s.uniform3fv(this.addr,e),qt(t,e)}}function Qx(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Xt(t,e))return;s.uniform4fv(this.addr,e),qt(t,e)}}function ey(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Xt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),qt(t,e)}else{if(Xt(t,n))return;Qf.set(n),s.uniformMatrix2fv(this.addr,!1,Qf),qt(t,n)}}function ty(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Xt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),qt(t,e)}else{if(Xt(t,n))return;jf.set(n),s.uniformMatrix3fv(this.addr,!1,jf),qt(t,n)}}function ny(s,e){let t=this.cache,n=e.elements;if(n===void 0){if(Xt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),qt(t,e)}else{if(Xt(t,n))return;$f.set(n),s.uniformMatrix4fv(this.addr,!1,$f),qt(t,n)}}function iy(s,e){let t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function sy(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Xt(t,e))return;s.uniform2iv(this.addr,e),qt(t,e)}}function ry(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Xt(t,e))return;s.uniform3iv(this.addr,e),qt(t,e)}}function oy(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Xt(t,e))return;s.uniform4iv(this.addr,e),qt(t,e)}}function ay(s,e){let t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function cy(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Xt(t,e))return;s.uniform2uiv(this.addr,e),qt(t,e)}}function ly(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Xt(t,e))return;s.uniform3uiv(this.addr,e),qt(t,e)}}function hy(s,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Xt(t,e))return;s.uniform4uiv(this.addr,e),qt(t,e)}}function uy(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(Kf.compareFunction=Ph,r=Kf):r=dp,t.setTexture2D(e||r,i)}function dy(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||pp,i)}function fy(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||mp,i)}function py(s,e,t){let n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||fp,i)}function my(s){switch(s){case 5126:return Jx;case 35664:return $x;case 35665:return jx;case 35666:return Qx;case 35674:return ey;case 35675:return ty;case 35676:return ny;case 5124:case 35670:return iy;case 35667:case 35671:return sy;case 35668:case 35672:return ry;case 35669:case 35673:return oy;case 5125:return ay;case 36294:return cy;case 36295:return ly;case 36296:return hy;case 35678:case 36198:case 36298:case 36306:case 35682:return uy;case 35679:case 36299:case 36307:return dy;case 35680:case 36300:case 36308:case 36293:return fy;case 36289:case 36303:case 36311:case 36292:return py}}function gy(s,e){s.uniform1fv(this.addr,e)}function _y(s,e){let t=Mr(e,this.size,2);s.uniform2fv(this.addr,t)}function xy(s,e){let t=Mr(e,this.size,3);s.uniform3fv(this.addr,t)}function yy(s,e){let t=Mr(e,this.size,4);s.uniform4fv(this.addr,t)}function vy(s,e){let t=Mr(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function My(s,e){let t=Mr(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Sy(s,e){let t=Mr(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function by(s,e){s.uniform1iv(this.addr,e)}function Ey(s,e){s.uniform2iv(this.addr,e)}function Ty(s,e){s.uniform3iv(this.addr,e)}function wy(s,e){s.uniform4iv(this.addr,e)}function Ay(s,e){s.uniform1uiv(this.addr,e)}function Ry(s,e){s.uniform2uiv(this.addr,e)}function Cy(s,e){s.uniform3uiv(this.addr,e)}function Iy(s,e){s.uniform4uiv(this.addr,e)}function Py(s,e,t){let n=this.cache,i=e.length,r=$c(t,i);Xt(n,r)||(s.uniform1iv(this.addr,r),qt(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||dp,r[o])}function Ly(s,e,t){let n=this.cache,i=e.length,r=$c(t,i);Xt(n,r)||(s.uniform1iv(this.addr,r),qt(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||pp,r[o])}function Dy(s,e,t){let n=this.cache,i=e.length,r=$c(t,i);Xt(n,r)||(s.uniform1iv(this.addr,r),qt(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||mp,r[o])}function Ny(s,e,t){let n=this.cache,i=e.length,r=$c(t,i);Xt(n,r)||(s.uniform1iv(this.addr,r),qt(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||fp,r[o])}function Uy(s){switch(s){case 5126:return gy;case 35664:return _y;case 35665:return xy;case 35666:return yy;case 35674:return vy;case 35675:return My;case 35676:return Sy;case 5124:case 35670:return by;case 35667:case 35671:return Ey;case 35668:case 35672:return Ty;case 35669:case 35673:return wy;case 5125:return Ay;case 36294:return Ry;case 36295:return Cy;case 36296:return Iy;case 35678:case 36198:case 36298:case 36306:case 35682:return Py;case 35679:case 36299:case 36307:return Ly;case 35680:case 36300:case 36308:case 36293:return Dy;case 36289:case 36303:case 36311:case 36292:return Ny}}var qh=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=my(t.type)}},Yh=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Uy(t.type)}},Kh=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let i=this.seq;for(let r=0,o=i.length;r!==o;++r){let a=i[r];a.setValue(e,t[a.id],n)}}},Xh=/(\w+)(\])?(\[|\.)?/g;function ep(s,e){s.seq.push(e),s.map[e.id]=e}function Fy(s,e,t){let n=s.name,i=n.length;for(Xh.lastIndex=0;;){let r=Xh.exec(n),o=Xh.lastIndex,a=r[1],c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===i){ep(t,l===void 0?new qh(a,s,e):new Yh(a,s,e));break}else{let u=t.map[a];u===void 0&&(u=new Kh(a),ep(t,u)),t=u}}}var yr=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){let r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);Fy(r,o,this)}}setValue(e,t,n,i){let r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){let i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){let a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,i)}}static seqWithValue(e,t){let n=[];for(let i=0,r=e.length;i!==r;++i){let o=e[i];o.id in t&&n.push(o)}return n}};function tp(s,e,t){let n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}var Oy=37297,By=0;function zy(s,e){let t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){let a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}var np=new Qe;function ky(s){ct._getMatrix(np,ct.workingColorSpace,s);let e=`mat3( ${np.elements.map(t=>t.toFixed(4))} )`;switch(ct.getTransfer(s)){case Zr:return[e,"LinearTransferOETF"];case Mt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function ip(s,e,t){let n=s.getShaderParameter(e,s.COMPILE_STATUS),r=(s.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let o=/ERROR: 0:(\d+)/.exec(r);if(o){let a=parseInt(o[1]);return t.toUpperCase()+`

`+r+`

`+zy(s.getShaderSource(e),a)}else return r}function Hy(s,e){let t=ky(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Vy(s,e){let t;switch(e){case uf:t="Linear";break;case df:t="Reinhard";break;case ff:t="Cineon";break;case oc:t="ACESFilmic";break;case mf:t="AgX";break;case gf:t="Neutral";break;case pf:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Zc=new S;function Gy(){ct.getLuminanceCoefficients(Zc);let s=Zc.x.toFixed(4),e=Zc.y.toFixed(4),t=Zc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Wy(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(zo).join(`
`)}function Xy(s){let e=[];for(let t in s){let n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function qy(s,e){let t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){let r=s.getActiveAttrib(e,i),o=r.name,a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function zo(s){return s!==""}function sp(s,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function rp(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var Yy=/^[ \t]*#include +<([\w\d./]+)>/gm;function Zh(s){return s.replace(Yy,Zy)}var Ky=new Map;function Zy(s,e){let t=et[e];if(t===void 0){let n=Ky.get(e);if(n!==void 0)t=et[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Zh(t)}var Jy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function op(s){return s.replace(Jy,$y)}function $y(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function ap(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function jy(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===xh?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Gd?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ai&&(e="SHADOWMAP_TYPE_VSM"),e}function Qy(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ss:case bs:e="ENVMAP_TYPE_CUBE";break;case Do:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ev(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case bs:e="ENVMAP_MODE_REFRACTION";break}return e}function tv(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case rc:e="ENVMAP_BLENDING_MULTIPLY";break;case lf:e="ENVMAP_BLENDING_MIX";break;case hf:e="ENVMAP_BLENDING_ADD";break}return e}function nv(s){let e=s.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function iv(s,e,t,n){let i=s.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,c=jy(t),l=Qy(t),h=ev(t),u=tv(t),d=nv(t),f=Wy(t),m=Xy(r),_=i.createProgram(),g,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
Program Info Log: `+Z+`
`+fe+`
`+we)}else Z!==""?console.warn("THREE.WebGLProgram: Program Info Log:",Z):(B===""||ie==="")&&(V=!1);V&&(L.diagnostics={runnable:q,programLog:Z,vertexShader:{log:B,prefix:g},fragmentShader:{log:ie,prefix:p}})}i.deleteShader(R),i.deleteShader(w),I=new yr(i,_),b=qy(i,_)}let I;this.getUniforms=function(){return I===void 0&&P(this),I};let b;this.getAttributes=function(){return b===void 0&&P(this),b};let M=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return M===!1&&(M=i.getProgramParameter(_,Oy)),M},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=By++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=R,this.fragmentShader=w,this}var sv=0,Jh=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){let t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){let t=this.shaderCache,n=t.get(e);return n===void 0&&(n=new $h(e),t.set(e,n)),n}},$h=class{constructor(e){this.id=sv++,this.code=e,this.usedTimes=0}};function rv(s,e,t,n,i,r,o){let a=new jr,c=new Jh,l=new Set,h=[],u=i.logarithmicDepthBuffer,d=i.vertexTextures,f=i.precision,m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(b){return l.add(b),b===0?"uv":`uv${b}`}function g(b,M,L,H,X){let $=H.fog,Z=X.geometry,B=b.isMeshStandardMaterial?H.environment:null,ie=(b.isMeshStandardMaterial?t:e).get(b.envMap||B),q=ie&&ie.mapping===Do?ie.image.height:null,V=m[b.type];b.precision!==null&&(f=i.getMaxPrecision(b.precision),f!==b.precision&&console.warn("THREE.WebGLProgram.getParameters:",b.precision,"not supported, using",f,"instead."));let fe=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,we=fe!==void 0?fe.length:0,Ve=0;Z.morphAttributes.position!==void 0&&(Ve=1),Z.morphAttributes.normal!==void 0&&(Ve=2),Z.morphAttributes.color!==void 0&&(Ve=3);let tt,lt,rt,te;if(V){let Ye=ci[V];tt=Ye.vertexShader,lt=Ye.fragmentShader}else tt=b.vertexShader,lt=b.fragmentShader,c.update(b),rt=c.getVertexShaderID(b),te=c.getFragmentShaderID(b);let N=s.getRenderTarget(),W=s.state.buffers.depth.getReversed(),ne=X.isInstancedMesh===!0,re=X.isBatchedMesh===!0,be=!!b.map,ve=!!b.matcap,C=!!ie,Q=!!b.aoMap,G=!!b.lightMap,J=!!b.bumpMap,ee=!!b.normalMap,pe=!!b.displacementMap,oe=!!b.emissiveMap,ge=!!b.metalnessMap,Ge=!!b.roughnessMap,Ze=b.anisotropy>0,A=b.clearcoat>0,v=b.dispersion>0,O=b.iridescence>0,K=b.sheen>0,ae=b.transmission>0,j=Ze&&!!b.anisotropyMap,Pe=A&&!!b.clearcoatMap,_e=A&&!!b.clearcoatNormalMap,De=A&&!!b.clearcoatRoughnessMap,Le=O&&!!b.iridescenceMap,le=O&&!!b.iridescenceThicknessMap,xe=K&&!!b.sheenColorMap,We=K&&!!b.sheenRoughnessMap,Ne=!!b.specularMap,Se=!!b.specularColorMap,Xe=!!b.specularIntensityMap,D=ae&&!!b.transmissionMap,ue=ae&&!!b.thicknessMap,Me=!!b.gradientMap,Ie=!!b.alphaMap,de=b.alphaTest>0,se=!!b.alphaHash,Y=!!b.extensions,me=Ai;b.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(me=s.toneMapping);let nt={shaderID:V,shaderType:b.type,shaderName:b.name,vertexShader:tt,fragmentShader:lt,defines:b.defines,customVertexShaderID:rt,customFragmentShaderID:te,isRawShaderMaterial:b.isRawShaderMaterial===!0,glslVersion:b.glslVersion,precision:f,batching:re,batchingColor:re&&X._colorsTexture!==null,instancing:ne,instancingColor:ne&&X.instanceColor!==null,instancingMorph:ne&&X.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:N===null?s.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:Qt,alphaToCoverage:!!b.alphaToCoverage,map:be,matcap:ve,envMap:C,envMapMode:C&&ie.mapping,envMapCubeUVHeight:q,aoMap:Q,lightMap:G,bumpMap:J,normalMap:ee,displacementMap:d&&pe,emissiveMap:oe,normalMapObjectSpace:ee&&b.normalMapType===Ef,normalMapTangentSpace:ee&&b.normalMapType===qc,metalnessMap:ge,roughnessMap:Ge,anisotropy:Ze,anisotropyMap:j,clearcoat:A,clearcoatMap:Pe,clearcoatNormalMap:_e,clearcoatRoughnessMap:De,dispersion:v,iridescence:O,iridescenceMap:Le,iridescenceThicknessMap:le,sheen:K,sheenColorMap:xe,sheenRoughnessMap:We,specularMap:Ne,specularColorMap:Se,specularIntensityMap:Xe,transmission:ae,transmissionMap:D,thicknessMap:ue,gradientMap:Me,opaque:b.transparent===!1&&b.blending===cs&&b.alphaToCoverage===!1,alphaMap:Ie,alphaTest:de,alphaHash:se,combine:b.combine,mapUv:be&&_(b.map.channel),aoMapUv:Q&&_(b.aoMap.channel),lightMapUv:G&&_(b.lightMap.channel),bumpMapUv:J&&_(b.bumpMap.channel),normalMapUv:ee&&_(b.normalMap.channel),displacementMapUv:pe&&_(b.displacementMap.channel),emissiveMapUv:oe&&_(b.emissiveMap.channel),metalnessMapUv:ge&&_(b.metalnessMap.channel),roughnessMapUv:Ge&&_(b.roughnessMap.channel),anisotropyMapUv:j&&_(b.anisotropyMap.channel),clearcoatMapUv:Pe&&_(b.clearcoatMap.channel),clearcoatNormalMapUv:_e&&_(b.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:De&&_(b.clearcoatRoughnessMap.channel),iridescenceMapUv:Le&&_(b.iridescenceMap.channel),iridescenceThicknessMapUv:le&&_(b.iridescenceThicknessMap.channel),sheenColorMapUv:xe&&_(b.sheenColorMap.channel),sheenRoughnessMapUv:We&&_(b.sheenRoughnessMap.channel),specularMapUv:Ne&&_(b.specularMap.channel),specularColorMapUv:Se&&_(b.specularColorMap.channel),specularIntensityMapUv:Xe&&_(b.specularIntensityMap.channel),transmissionMapUv:D&&_(b.transmissionMap.channel),thicknessMapUv:ue&&_(b.thicknessMap.channel),alphaMapUv:Ie&&_(b.alphaMap.channel),vertexTangents:!!Z.attributes.tangent&&(ee||Ze),vertexColors:b.vertexColors,vertexAlphas:b.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,pointsUvs:X.isPoints===!0&&!!Z.attributes.uv&&(be||Ie),fog:!!$,useFog:b.fog===!0,fogExp2:!!$&&$.isFogExp2,flatShading:b.flatShading===!0&&b.wireframe===!1,sizeAttenuation:b.sizeAttenuation===!0,logarithmicDepthBuffer:u,reversedDepthBuffer:W,skinning:X.isSkinnedMesh===!0,morphTargets:Z.morphAttributes.position!==void 0,morphNormals:Z.morphAttributes.normal!==void 0,morphColors:Z.morphAttributes.color!==void 0,morphTargetsCount:we,morphTextureStride:Ve,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:b.dithering,shadowMapEnabled:s.shadowMap.enabled&&L.length>0,shadowMapType:s.shadowMap.type,toneMapping:me,decodeVideoTexture:be&&b.map.isVideoTexture===!0&&ct.getTransfer(b.map.colorSpace)===Mt,decodeVideoTextureEmissive:oe&&b.emissiveMap.isVideoTexture===!0&&ct.getTransfer(b.emissiveMap.colorSpace)===Mt,premultipliedAlpha:b.premultipliedAlpha,doubleSided:b.side===Pt,flipSided:b.side===tn,useDepthPacking:b.depthPacking>=0,depthPacking:b.depthPacking||0,index0AttributeName:b.index0AttributeName,extensionClipCullDistance:Y&&b.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Y&&b.extensions.multiDraw===!0||re)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:b.customProgramCacheKey()};return nt.vertexUv1s=l.has(1),nt.vertexUv2s=l.has(2),nt.vertexUv3s=l.has(3),l.clear(),nt}function p(b){let M=[];if(b.shaderID?M.push(b.shaderID):(M.push(b.customVertexShaderID),M.push(b.customFragmentShaderID)),b.defines!==void 0)for(let L in b.defines)M.push(L),M.push(b.defines[L]);return b.isRawShaderMaterial===!1&&(T(M,b),y(M,b),M.push(s.outputColorSpace)),M.push(b.customProgramCacheKey),M.join()}function T(b,M){b.push(M.precision),b.push(M.outputColorSpace),b.push(M.envMapMode),b.push(M.envMapCubeUVHeight),b.push(M.mapUv),b.push(M.alphaMapUv),b.push(M.lightMapUv),b.push(M.aoMapUv),b.push(M.bumpMapUv),b.push(M.normalMapUv),b.push(M.displacementMapUv),b.push(M.emissiveMapUv),b.push(M.metalnessMapUv),b.push(M.roughnessMapUv),b.push(M.anisotropyMapUv),b.push(M.clearcoatMapUv),b.push(M.clearcoatNormalMapUv),b.push(M.clearcoatRoughnessMapUv),b.push(M.iridescenceMapUv),b.push(M.iridescenceThicknessMapUv),b.push(M.sheenColorMapUv),b.push(M.sheenRoughnessMapUv),b.push(M.specularMapUv),b.push(M.specularColorMapUv),b.push(M.specularIntensityMapUv),b.push(M.transmissionMapUv),b.push(M.thicknessMapUv),b.push(M.combine),b.push(M.fogExp2),b.push(M.sizeAttenuation),b.push(M.morphTargetsCount),b.push(M.morphAttributeCount),b.push(M.numDirLights),b.push(M.numPointLights),b.push(M.numSpotLights),b.push(M.numSpotLightMaps),b.push(M.numHemiLights),b.push(M.numRectAreaLights),b.push(M.numDirLightShadows),b.push(M.numPointLightShadows),b.push(M.numSpotLightShadows),b.push(M.numSpotLightShadowsWithMaps),b.push(M.numLightProbes),b.push(M.shadowMapType),b.push(M.toneMapping),b.push(M.numClippingPlanes),b.push(M.numClipIntersection),b.push(M.depthPacking)}function y(b,M){a.disableAll(),M.supportsVertexTextures&&a.enable(0),M.instancing&&a.enable(1),M.instancingColor&&a.enable(2),M.instancingMorph&&a.enable(3),M.matcap&&a.enable(4),M.envMap&&a.enable(5),M.normalMapObjectSpace&&a.enable(6),M.normalMapTangentSpace&&a.enable(7),M.clearcoat&&a.enable(8),M.iridescence&&a.enable(9),M.alphaTest&&a.enable(10),M.vertexColors&&a.enable(11),M.vertexAlphas&&a.enable(12),M.vertexUv1s&&a.enable(13),M.vertexUv2s&&a.enable(14),M.vertexUv3s&&a.enable(15),M.vertexTangents&&a.enable(16),M.anisotropy&&a.enable(17),M.alphaHash&&a.enable(18),M.batching&&a.enable(19),M.dispersion&&a.enable(20),M.batchingColor&&a.enable(21),M.gradientMap&&a.enable(22),b.push(a.mask),a.disableAll(),M.fog&&a.enable(0),M.useFog&&a.enable(1),M.flatShading&&a.enable(2),M.logarithmicDepthBuffer&&a.enable(3),M.reversedDepthBuffer&&a.enable(4),M.skinning&&a.enable(5),M.morphTargets&&a.enable(6),M.morphNormals&&a.enable(7),M.morphColors&&a.enable(8),M.premultipliedAlpha&&a.enable(9),M.shadowMapEnabled&&a.enable(10),M.doubleSided&&a.enable(11),M.flipSided&&a.enable(12),M.useDepthPacking&&a.enable(13),M.dithering&&a.enable(14),M.transmission&&a.enable(15),M.sheen&&a.enable(16),M.opaque&&a.enable(17),M.pointsUvs&&a.enable(18),M.decodeVideoTexture&&a.enable(19),M.decodeVideoTextureEmissive&&a.enable(20),M.alphaToCoverage&&a.enable(21),b.push(a.mask)}function x(b){let M=m[b.type],L;if(M){let H=ci[M];L=Uf.clone(H.uniforms)}else L=b.uniforms;return L}function R(b,M){let L;for(let H=0,X=h.length;H<X;H++){let $=h[H];if($.cacheKey===M){L=$,++L.usedTimes;break}}return L===void 0&&(L=new iv(s,M,b,r),h.push(L)),L}function w(b){if(--b.usedTimes===0){let M=h.indexOf(b);h[M]=h[h.length-1],h.pop(),b.destroy()}}function P(b){c.remove(b)}function I(){c.dispose()}return{getParameters:g,getProgramCacheKey:p,getUniforms:x,acquireProgram:R,releaseProgram:w,releaseShaderCache:P,programs:h,dispose:I}}function ov(){let s=new WeakMap;function e(o){return s.has(o)}function t(o){let a=s.get(o);return a===void 0&&(a={},s.set(o,a)),a}function n(o){s.delete(o)}function i(o,a,c){s.get(o)[a]=c}function r(){s=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:r}}function av(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function cp(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function lp(){let s=[],e=0,t=[],n=[],i=[];function r(){e=0,t.length=0,n.length=0,i.length=0}function o(u,d,f,m,_,g){let p=s[e];return p===void 0?(p={id:u.id,object:u,geometry:d,material:f,groupOrder:m,renderOrder:u.renderOrder,z:_,group:g},s[e]=p):(p.id=u.id,p.object=u,p.geometry=d,p.material=f,p.groupOrder=m,p.renderOrder=u.renderOrder,p.z=_,p.group=g),e++,p}function a(u,d,f,m,_,g){let p=o(u,d,f,m,_,g);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function c(u,d,f,m,_,g){let p=o(u,d,f,m,_,g);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function l(u,d){t.length>1&&t.sort(u||av),n.length>1&&n.sort(d||cp),i.length>1&&i.sort(d||cp)}function h(){for(let u=e,d=s.length;u<d;u++){let f=s[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:r,push:a,unshift:c,finish:h,sort:l}}function cv(){let s=new WeakMap;function e(n,i){let r=s.get(n),o;return r===void 0?(o=new lp,s.set(n,[o])):i>=r.length?(o=new lp,r.push(o)):o=r[i],o}function t(){s=new WeakMap}return{get:e,dispose:t}}function lv(){let s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new S,color:new Ue};break;case"SpotLight":t={position:new S,direction:new S,color:new Ue,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new S,color:new Ue,distance:0,decay:0};break;case"HemisphereLight":t={direction:new S,skyColor:new Ue,groundColor:new Ue};break;case"RectAreaLight":t={color:new Ue,position:new S,halfWidth:new S,halfHeight:new S};break}return s[e.id]=t,t}}}function hv(){let s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ye};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ye};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ye,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=t,t}}}var uv=0;function dv(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function fv(s){let e=new lv,t=hv(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new S);let i=new S,r=new Be,o=new Be;function a(l){let h=0,u=0,d=0;for(let b=0;b<9;b++)n.probe[b].set(0,0,0);let f=0,m=0,_=0,g=0,p=0,T=0,y=0,x=0,R=0,w=0,P=0;l.sort(dv);for(let b=0,M=l.length;b<M;b++){let L=l[b],H=L.color,X=L.intensity,$=L.distance,Z=L.shadow&&L.shadow.map?L.shadow.map.texture:null;if(L.isAmbientLight)h+=H.r*X,u+=H.g*X,d+=H.b*X;else if(L.isLightProbe){for(let B=0;B<9;B++)n.probe[B].addScaledVector(L.sh.coefficients[B],X);P++}else if(L.isDirectionalLight){let B=e.get(L);if(B.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){let ie=L.shadow,q=t.get(L);q.shadowIntensity=ie.intensity,q.shadowBias=ie.bias,q.shadowNormalBias=ie.normalBias,q.shadowRadius=ie.radius,q.shadowMapSize=ie.mapSize,n.directionalShadow[f]=q,n.directionalShadowMap[f]=Z,n.directionalShadowMatrix[f]=L.shadow.matrix,T++}n.directional[f]=B,f++}else if(L.isSpotLight){let B=e.get(L);B.position.setFromMatrixPosition(L.matrixWorld),B.color.copy(H).multiplyScalar(X),B.distance=$,B.coneCos=Math.cos(L.angle),B.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),B.decay=L.decay,n.spot[_]=B;let ie=L.shadow;if(L.map&&(n.spotLightMap[R]=L.map,R++,ie.updateMatrices(L),L.castShadow&&w++),n.spotLightMatrix[_]=ie.matrix,L.castShadow){let q=t.get(L);q.shadowIntensity=ie.intensity,q.shadowBias=ie.bias,q.shadowNormalBias=ie.normalBias,q.shadowRadius=ie.radius,q.shadowMapSize=ie.mapSize,n.spotShadow[_]=q,n.spotShadowMap[_]=Z,x++}_++}else if(L.isRectAreaLight){let B=e.get(L);B.color.copy(H).multiplyScalar(X),B.halfWidth.set(L.width*.5,0,0),B.halfHeight.set(0,L.height*.5,0),n.rectArea[g]=B,g++}else if(L.isPointLight){let B=e.get(L);if(B.color.copy(L.color).multiplyScalar(L.intensity),B.distance=L.distance,B.decay=L.decay,L.castShadow){let ie=L.shadow,q=t.get(L);q.shadowIntensity=ie.intensity,q.shadowBias=ie.bias,q.shadowNormalBias=ie.normalBias,q.shadowRadius=ie.radius,q.shadowMapSize=ie.mapSize,q.shadowCameraNear=ie.camera.near,q.shadowCameraFar=ie.camera.far,n.pointShadow[m]=q,n.pointShadowMap[m]=Z,n.pointShadowMatrix[m]=L.shadow.matrix,y++}n.point[m]=B,m++}else if(L.isHemisphereLight){let B=e.get(L);B.skyColor.copy(L.color).multiplyScalar(X),B.groundColor.copy(L.groundColor).multiplyScalar(X),n.hemi[p]=B,p++}}g>0&&(s.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=Te.LTC_FLOAT_1,n.rectAreaLTC2=Te.LTC_FLOAT_2):(n.rectAreaLTC1=Te.LTC_HALF_1,n.rectAreaLTC2=Te.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;let I=n.hash;(I.directionalLength!==f||I.pointLength!==m||I.spotLength!==_||I.rectAreaLength!==g||I.hemiLength!==p||I.numDirectionalShadows!==T||I.numPointShadows!==y||I.numSpotShadows!==x||I.numSpotMaps!==R||I.numLightProbes!==P)&&(n.directional.length=f,n.spot.length=_,n.rectArea.length=g,n.point.length=m,n.hemi.length=p,n.directionalShadow.length=T,n.directionalShadowMap.length=T,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=T,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=x+R-w,n.spotLightMap.length=R,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=P,I.directionalLength=f,I.pointLength=m,I.spotLength=_,I.rectAreaLength=g,I.hemiLength=p,I.numDirectionalShadows=T,I.numPointShadows=y,I.numSpotShadows=x,I.numSpotMaps=R,I.numLightProbes=P,n.version=uv++)}function c(l,h){let u=0,d=0,f=0,m=0,_=0,g=h.matrixWorldInverse;for(let p=0,T=l.length;p<T;p++){let y=l[p];if(y.isDirectionalLight){let x=n.directional[u];x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(g),u++}else if(y.isSpotLight){let x=n.spot[f];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(g),x.direction.setFromMatrixPosition(y.matrixWorld),i.setFromMatrixPosition(y.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(g),f++}else if(y.isRectAreaLight){let x=n.rectArea[m];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(g),o.identity(),r.copy(y.matrixWorld),r.premultiply(g),o.extractRotation(r),x.halfWidth.set(y.width*.5,0,0),x.halfHeight.set(0,y.height*.5,0),x.halfWidth.applyMatrix4(o),x.halfHeight.applyMatrix4(o),m++}else if(y.isPointLight){let x=n.point[d];x.position.setFromMatrixPosition(y.matrixWorld),x.position.applyMatrix4(g),d++}else if(y.isHemisphereLight){let x=n.hemi[_];x.direction.setFromMatrixPosition(y.matrixWorld),x.direction.transformDirection(g),_++}}}return{setup:a,setupView:c,state:n}}function hp(s){let e=new fv(s),t=[],n=[];function i(h){l.camera=h,t.length=0,n.length=0}function r(h){t.push(h)}function o(h){n.push(h)}function a(){e.setup(t)}function c(h){e.setupView(t,h)}let l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:l,setupLights:a,setupLightsView:c,pushLight:r,pushShadow:o}}function pv(s){let e=new WeakMap;function t(i,r=0){let o=e.get(i),a;return o===void 0?(a=new hp(s),e.set(i,[a])):r>=o.length?(a=new hp(s),o.push(a)):a=o[r],a}function n(){e=new WeakMap}return{get:t,dispose:n}}var mv=`void main() {
	gl_Position = vec4( position, 1.0 );
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      #endif`)},M.customProgramCacheKey=()=>"okarar-anatomical-crystal-v7",c.push(M),I.material=M,I.frustumCulled=!1});let h=new Lo(t),u=s.animations.find(I=>I.name==="swimming");h.clipAction(u).play();let d=s.animations.find(I=>I.name==="bite").tracks.filter(I=>/^(Jaw|[LR]_upper_Lip|Center_upper_Lip|Upper_Teeth)/.test(I.name)).map(I=>{let[b,M]=I.name.split("."),L=t.getObjectByName(b),H=u.tracks.find(X=>X.name===I.name)?.createInterpolant();return{bone:L,property:M,native:H,rest:L[M].toArray(),value:Array.from(I.createInterpolant().evaluate(.45))}}),f=t.getObjectByName("Upper_Teeth12"),m=t.getObjectByName("Jaw6"),_=new br,g=.13;e.updateWorldMatrix(!0,!0);let p=m.worldToLocal(f.getWorldPosition(new S).add(new S(0,-.28,.4).multiplyScalar(6.49/i.z).applyAxisAngle(new S(0,1,0),Math.PI/2))),T=new Fe,y=new S;function x({phase:I,amplitude:b=.6,jawOpen:M=.13,engulf:L=0,dt:H=1/60,instant:X=!1}){let $=(I%(Math.PI*2)+Math.PI*2)%(Math.PI*2)/(Math.PI*2);h.setTime($*u.duration);for(let{bone:B,rest:ie}of l)/Spine|BackFin|DorsalFin|[LR]_Fin/.test(B.name)&&B.quaternion.slerpQuaternions(ie,B.quaternion.clone(),.35+b*1.05);g=_.update(M,H,X);let Z=Math.max(0,(g-.13)/(1-.13));for(let B of d)B.bone&&(B.bone[B.property].fromArray(B.native?B.native.evaluate($*u.duration):B.rest),B.property==="quaternion"?B.bone.quaternion.slerp(T.fromArray(B.value),Z*(B.bone===m?1+L*.3:1)):B.bone[B.property].lerp(y.fromArray(B.value),Z));e.updateWorldMatrix(!0,!0)}function R(){e.updateWorldMatrix(!0,!0);let I=f.getWorldPosition(new S);return e.worldToLocal(I).add(new S(.05,-.07-g*.12,0))}function w(){e.updateWorldMatrix(!0,!0);let I=e.worldToLocal(f.getWorldPosition(new S)),b=e.worldToLocal(m.localToWorld(p.clone())),M=I.clone().lerp(b,.2),L=new S(I.y-b.y,b.x-I.x,0).normalize();return M.addScaledVector(L,.035),{center:M,upper:I,lower:b,normal:L,width:.96,height:Math.max(.14,I.distanceTo(b))}}function P(I,b,M){let L=R(),H=e.localToWorld(L.clone()).project(I),X=(H.x+1)*b/2,$=(1-H.y)*M/2,Z=[];for(let B of[-1,1])for(let ie of[-1,1])Z.push(e.localToWorld(L.clone().add(new S(0,B*(.1+g*.2),ie*.43))).project(I));return{x:X,y:$,left:Math.min(...Z.map(B=>(B.x+1)*b/2)),right:Math.max(...Z.map(B=>(B.x+1)*b/2)),top:Math.min(...Z.map(B=>(1-B.y)*M/2)),bottom:Math.max(...Z.map(B=>(1-B.y)*M/2))}}return{group:e,animate:x,localMouth:R,mouth:P,aperture:w,get jawOpen(){return g},setLight(I){for(let b of c)b.normalScale.setScalar(I?.25:.36)},setFinish(I){for(let b of c)b.roughness=.16-I*.12,b.transmission=.86+I*.14},setColor(I){let b={pearl:["#d9edee","#9abfc6"],iris:["#e8def3","#a991bc"],ember:["#f3e3ce","#c1a581"]},M=b[I]||b.pearl;for(let L of c)L.color.set(M[0]),L.attenuationColor.set(M[1])}}}var cn=Math.PI,ol=xt.clamp,bp=new S(1.03,-.13,0),hi=1.03,Wo=2.43,kv=new kt([[-2.83,.075,.075],[-2.5,.12,.1],[-2.12,.22,.19],[-1.65,.39,.32],[-1,.58,.46],[-.3,.7,.61],[.35,.73,.7],[.85,.67,.73],[1.3,.64,.73],[1.72,.59,.71],[2.07,.5,.64],[2.32,.39,.52],[2.48,.29,.4],[2.62,.14,.22],[2.69,.004,.004]].map(s=>new S(...s))),rl=kv.getPoints(600);function Du(s){let e=0,t=rl.length-1;for(;t-e>1;){let o=e+t>>1;rl[o].x<s?e=o:t=o}let n=rl[e],i=rl[t],r=ol((s-n.x)/(i.x-n.x),0,1);return{ry:xt.lerp(n.y,i.y,r),rz:xt.lerp(n.z,i.z,r),cy:.02}}function Ps(s){if(s<hi||s>=Wo)return cn/2;let e=(s-hi)/(Wo-hi),t=Du(s),n=xt.lerp(-.13,t.cy-t.ry,e*e*(3-2*e)),i=Math.asin(ol((t.cy-n)/t.ry,0,1));return xt.lerp(cn/2,i,xt.smoothstep(e,0,.13))}function Ci(s,e){let t=Du(s),n=t.cy+t.ry*Math.sin(e),i=.035*Math.exp(-Math.pow((s-1.72)/.19,2)-Math.pow((n-.26)/.12,2));return new S(s,n,(t.rz-i)*Math.cos(e))}function Go(s,e,t,n=!1){let i=[],r=[];for(let a=0;a<=e;a++)for(let c=0;c<=t;c++){let l=s(a/e,c/t);i.push(l.x,l.y,l.z)}for(let a=0;a<e;a++)for(let c=0;c<t;c++){let l=a*(t+1)+c,h=l+1,u=l+t+1,d=u+1;r.push(...n?[l,h,u,h,d,u]:[l,u,h,h,u,d])}let o=new mt;return o.setAttribute("position",new Je(i,3)),o.setIndex(r),o.computeVertexNormals(),o.computeBoundingSphere(),o}function Ep(s){return new ti(...s.map(e=>new S(...e)))}function Hv(s,e,t,n,i){let r=Ep(s),o=Ep(e),a=new S(...t),c=[];for(let l of[1,-1])c.push(Go((h,u)=>{let d=r.getPoint(h).lerp(o.getPoint(h),u),f=Math.pow(Math.sin(cn*u),.72)*Math.pow(1-h,.75)*n;return d.addScaledVector(a,l*f),d},i,16,l<0));return c}var Vv=`
...
vec3 swim(vec3 p){
  ...
  return p;
}`;function Gv({mobile:s=!1}={}){let e=new Dt;e.visible=!1,e.name="glass-shark";let t={uSwimPhase:{value:0},uSwimFlow:{value:.6},uJawOpen:{value:0}},n=[];function i(N,{jaw:W=!1,fin:ne=!1,web:re=!1,skin:be=!1}={}){return N.onBeforeCompile=ve=>{Object.assign(ve.uniforms,t,{uIsJaw:{value:Number(W)},uIsFin:{value:Number(ne)}}),ve.vertexShader=ve.vertexShader.replace("#include <common>",`#include <common>
`+(re?`#define JAW_WEB
`:"")+Vv+(be?`
...
`+sM),e.vertexShader=e.vertexShader.replace("#include <beginnormal_vertex>",`
      #include <beginnormal_vertex>
...
varying vec3 vMantaSurface;`),e.fragmentShader=e.fragmentShader.replace("#include <transmission_fragment>",et.transmission_fragment.replace("material.transmission = transmission;",`float torso=(1.-smoothstep(.42,.95,abs(vMantaSurface.x)))*smoothstep(-1.65,-.9,vMantaSurface.y);
    ...
    if(tuv.x>0.&&tuv.x<1.&&tuv.y>0.&&tuv.y<1.)col=mix(col,mix(vec3(.065,.125,.125),vec3(.17,.19,.21),uDark),texture2D(uText,tuv).a*uWord*mix(.88,.42,uDark));gl_FragColor=vec4(col*uAlpha,uAlpha);}`}),y=new Ke(new Mi(1,1),T);y.position.z=-12,y.renderOrder=-10,r.add(y);let x=0;y.onBeforeRender=()=>{T.uniforms.uAlpha.value=i.getRenderTarget()?1:1-x},document.querySelector(".wordmark").style.display="none";let R=new Dt;r.add(R);let w=new Dt;R.add(w);let P=Ji(new _t({color:14741997,metalness:0,roughness:.075,transmission:e?.85:.96,thickness:.65,ior:1.38,clearcoat:1,clearcoatRoughness:.04,iridescence:.4,iridescenceIOR:1.32,iridescenceThicknessRange:[200,410],attenuationColor:5149336,attenuationDistance:2.8,envMapIntensity:1.3,side:Pt})),I=Ji(P.clone()),b=Ji(P.clone());I.vertexColors=b.vertexColors=!0,I.color.set("#eef3ef"),I.transmission=.91,I.thickness=.44,I.roughness=.095,b.color.set("#f5f3e8"),b.transmission=.64,b.thickness=.34,b.roughness=.13;let M=new Ke(Ip(e?80:144,e?36:64),[I,b]);M.name="manta-anatomical-disc",w.add(M);let L={back:I,belly:b,rim:Ji(new _t({color:"#a0c6c9",roughness:.12,transmission:.7,thickness:.1,ior:1.37,clearcoat:.7})),interior:Ji(new _t({color:"#183840",roughness:.27,transmission:.12,thickness:.12,side:Pt})),fold:Ji(new _t({color:"#779fa4",roughness:.28,transmission:.35,thickness:.06})),eye:Ji(new _t({color:"#102a32",roughness:.065,metalness:.05,clearcoat:1})),gill:Ji(new _t({color:"#25414a",roughness:.36,side:$t}))};for(let Y of Lp(Pp({mobile:e}))){let me=new Ke(Y.geometry,L[Y.material]);me.name=Y.name,w.add(me)}let H=new yi({color:5344669,transparent:!0,opacity:.045,depthWrite:!1}),X=new yi({color:16380632,transparent:!0,opacity:.2,depthWrite:!1}),$=[];for(let Y of[-1,1])for(let me=1;me<=26;me++){let nt=me/27,Ye=[];for(let Ui=0;Ui<=36;Ui++){let pn=Ui/36,qn=Y*(.07*(1-pn)+nt*pn),ui=bt(.3,.2+nt*.78,pn),Tn=qo(qn,ui,1);Tn.z-=.014,Ye.push(Tn)}let Et=new mt().setFromPoints(Ye),ln=new Qn(Et,H);w.add(ln),$.push({line:ln,base:Et.attributes.position.array.slice()})}for(let Y of[0,1]){let me=[];for(let Et=0;Et<=180;Et++)me.push(qo(Et/90-1,Y,1));let nt=new mt().setFromPoints(me),Ye=new Qn(nt,X);w.add(Ye),$.push({line:Ye,base:nt.attributes.position.array.slice()})}let Z=im({mobile:e}),B=P.clone();B.onBeforeCompile=()=>{},B.customProgramCacheKey=()=>"okarar-tail-attached";let ie=new Ke(Z.geometry,B);ie.name="manta-attached-tail",w.add(ie);let q=new An(new S(0,0,1),1e4);R.traverse(Y=>{if(Y.material)for(let me of Array.isArray(Y.material)?Y.material:[Y.material])me.clippingPlanes=[q]});let V=Tp({mobile:e});r.add(V.group);let fe=null,we=null,Ve=!1,tt=new Dt;r.add(tt);let lt=[];for(let Y=0;Y<3;Y++){let me=new Ke(new bo(3.4+Y*.55,.015,8,150),new _t({color:10204596,metalness:.55,roughness:.25,transparent:!0,opacity:.3,depthWrite:!1}));me.rotation.set(.65+Y*.45,.45+Y*.18,-.2+Y*.1),me.position.z=-1.5-Y*.4,tt.add(me),lt.push(me)}let rt=new mt,te=[],N=72,W=()=>(N=N*16807%2147483647,(N-1)/2147483646);for(let Y=0;Y<(e?55:140);Y++)te.push((W()-.5)*22,(W()-.5)*15,(W()-.5)*12);rt.setAttribute("position",new Je(te,3));let ne=new vi(rt,new ei({color:5340039,size:.018,transparent:!0,opacity:.5,sizeAttenuation:!0}));r.add(ne);let re=[],be=new _t({color:14807276,metalness:.2,roughness:.06,transmission:e?0:.88,thickness:.18,ior:1.45,clearcoat:1});for(let Y=0;Y<(e?9:20);Y++){let me=new Ke(new So(.1+W()*.15,0),be);me.scale.set(.55+W(),1.5+W(),.38);let nt=W()*Math.PI*2,Ye=3.5+W()*3.3;me.userData={a:nt,r:Ye,z:(W()-.5)*4,speed:.025+W()*.04,scale:me.scale.clone()},me.rotation.set(W()*3,W()*3,W()*3),r.add(me),re.push(me)}let ve=e,C=.6,Q=.75,G="pearl",J=new yl(e),ee={pearl:[14741997,5149336,9353141,5344669,"#d4e3e3"],iris:[15655163,9599167,10655941,9069983,"#dfd4e7"],ember:[16771027,11892033,12688252,11106392,"#e7d7c9"]};function pe(Y){G=Y;let me=ee[Y];P.color.setHex(me[0]),P.attenuationColor.setHex(me[1]),I.color.setHex(me[0]),b.color.setHex(me[0]),H.color.setHex(me[3]),T.uniforms.uTint.value.set(me[4]),V.setColor(Y)}function oe(Y){Y!==null&&(P.transmission=Y?.78:bt(.75,.99,Q),I.transmission=Y?.81:.91,b.transmission=Y?.6:.64,be.transmission=Y?0:.88,re.forEach((me,nt)=>me.visible=!Y||nt<7),V.setLight(Y))}function ge(Y){ve=Y,i.setPixelRatio(Math.min(devicePixelRatio,Y?1:1.65)),oe(J.request(Y))}function Ge(){let Y=innerWidth,me=innerHeight;i.setSize(Y,me,!1),o.aspect=Y/me,o.updateProjectionMatrix(),T.uniforms.uAspect.value=Y/me}Ge(),s.addEventListener("webglcontextlost",Y=>{Y.preventDefault(),t()}),s.addEventListener("webglcontextrestored",()=>location.reload());let Ze=new S,A=new Fe,v=new Tt,O=new Be,K=new S(0,1,0),ae=new S(1,0,0),j=new Fe().setFromAxisAngle(K,-Math.PI/2),Pe=new Fe,_e=new Tt,De=new Ut().setFromObject(w).expandByVector(new S(.45,.02,.18)),Le=new dl(De),le=new ml,xe=new _l,We=new xl,Ne=[],Se=null,Xe=null,D=null,ue=-1,Me=null;function Ie(Y,me=0){return new Fe().setFromRotationMatrix(O.lookAt(Y,new S,K)).multiply(j).multiply(new Fe().setFromAxisAngle(ae,me))}function de({time:Y,phase:me,sharkPhase:nt=me,dt:Ye=1/60,position:Et,targetPosition:ln=Et,redirecting:Ui=!1,displayChapter:pn=0,entered:qn,pointer:ui,pulse:Tn,energy:mn,reduced:xn,paused:ji=!1,takeover:jo={active:!1,progress:0,dark:0,swallowed:0,returning:0},pass:gt=null,flourish:Yn=null,audioPosition:Qi=null}){let Un=s.hasAttribute("data-rhythm-debug"),Al=Un?performance.now():0,Rl=mn;mn=We.update(mn,Ye,xn||ji);let hn=innerWidth<=800,E=nm(Et,{small:hn,entered:qn,aspect:o.aspect}),F={...E},{active:k,progress:z,dark:U,returning:he=0}=jo,Ee=k&&z<1,Ae=Bp(z,he);oe(J.update({active:k,progress:z,veil:Ae.veil})),Nn.uCapture.value=Ee?He(.15,.32,z):0,q.constant=1e4,k&&!fe&&(fe={...E}),k&&z<1&&Object.assign(E,fe),k&&(E.z=bt(E.z,hn?16:11.8,wr(.72,1,z))),T.uniforms.uDark.value=U,r.environment=k&&z>=zp?f.texture:u.texture,m.intensity=bt(1.8,.7,U),_.intensity=bt(3.2,4.6,U),g.intensity=bt(2.4,4.2,U),_.color.setRGB(bt(1,.9,U),bt(.85,.95,U),bt(.76,1,U)),i.toneMappingExposure=bt(1.08,.92,U),o.position.set(ui.x*(xn?0:.22),ui.y*(xn?0:.14),E.z),o.lookAt(0,0,0),o.updateMatrixWorld(),x=k?Hp(z):0;let Re=document.querySelector(".wordmark");Re.style.display=x>0?"":"none";let ke=2*Math.tan(xt.degToRad(17.5))*(E.z+12)*1.12;if(y.scale.set(ke*o.aspect,ke,1),R.position.set(F.x,F.y+(xn?0:-Math.cos(me)*.08),0),w.quaternion.copy(F.q).multiply(Pe.setFromEuler(_e.set(ui.y*.1,ui.x*.14,0))),w.scale.setScalar(F.s*(1+Tn*.018+mn*.022)),R.visible=Xp({active:k,progress:z,veil:Ae.veil}),R.visible&&Yn&&(R.position.x+=Yn.x,R.position.y+=Yn.y,R.position.z+=Yn.z,Pe.setFromEuler(_e.set(Yn.rx,Yn.ry,Yn.rz)),w.quaternion.multiply(Pe),w.scale.multiplyScalar(Yn.scale)),k){let $e=hn?1.08:1.38,ze=Math.tan(Math.PI*35/360)*E.z*o.aspect,je=hn?.78:1.28,Ce=Rr(pn,0,5),pt=ze*(hn?.87:.73),at=Bu({chapter:Ce,small:hn,halfWidth:ze,time:Y,reduced:xn}),Ot=xe.active||Ui?Rr(Math.floor(ln+.265),0,5):Ce,Zt=Bu({chapter:Ot,small:hn,halfWidth:ze,time:Y,reduced:xn}),sn={group:V.group,idle:Zt,chapter:Ot,camera:o,bounds:V.entryBounds,small:hn,halfWidth:ze,dt:Ye,instant:xn&&!ji};if(Ze.copy(at.v),A.copy(at.q),V.group.visible=!0,V.animate({phase:nt,amplitude:C,jawOpen:Ee?Ae.jaw:.13,engulf:Ee?Ae.engulf:0,dt:Ye,instant:xn}),z<1){let{approach:Ht,surge:ut,exit:Vt}=Ae,yt=V.aperture(),Gt=bt(bt($e,3.4,Ht),4.3,ut),Rt=Math.atan2(-yt.normal.y,yt.normal.x);V.group.quaternion.setFromEuler(v.set(0,-Math.PI/2-.38*(1-Ht),Rt));let yn=Le.mouthScale(Gt,w.scale.x,z,yt,V.group.quaternion),Jt=Math.tan(Math.PI*35/360),Sm=Math.min(yt.width*yn/(2*Jt*o.aspect),yt.height*yn/(2*Jt))*.32,Us=new S(bt(fe.x+ze*.6,fe.x,Ht)*(1-ut),bt(fe.y+.22,0,ut),bt(bt(Nu,Fp,Ht),E.z-Math.max(.4,Sm),ut));if(!we){let Em=new S(fe.x+ze*.6,fe.y+.22,Nu),Tm=new Fe().setFromEuler(new Tt(0,-Math.PI/2-.38,Rt));we=tl(o,V.entryBounds,yt.center,Em,Tm,$e)}Us.addScaledVector(we,tu(z)),V.group.scale.setScalar(yn),V.group.position.copy(Us).sub(yt.center.clone().multiplyScalar(yn).applyQuaternion(V.group.quaternion));let Cl=yt.normal.clone().applyQuaternion(V.group.quaternion),Fs=Le.apply(R,w,z,{aperture:yt,rotation:V.group.quaternion,scale:yn,center:Us,fold:Nn.uCapture.value,flow:C,pulse:Tn+mn*.3});Fs?.retreat&&(Us.addScaledVector(Cl,-Fs.retreat),V.group.position.addScaledVector(Cl,-Fs.retreat));let bm=qp(q,Us,Cl,yt.width,yn,Fs?.deepest??0);Un&&(s.dataset.throatDepth=String(bm)),Un&&(s.dataset.captureFit=JSON.stringify({scale:w.scale.x,position:R.position.toArray(),fold:Nn.uCapture.value,depth:Fs?.depth??0,recession:Fs?.recession??0,mouth:Us.toArray()})),V.group.position.lerp(new S(-ze-9,fe.y+.39,-5),Vt),V.group.quaternion.slerp(new Fe().setFromEuler(v.set(...ul)),Vt),V.group.scale.setScalar(bt(yn,$e,Vt))}else if(le.complete)if(xe.active)xe.update(sn),D=null,ue=-1;else if(gt){if(D?.id!==gt.id){let Rt=V.group.position.clone(),yn=V.group.quaternion.clone(),Jt;gt.chapter===0?Jt=null:gt.chapter===1?Jt=[Rt,new S(-ze*.6,-.5,1),new S(.1,.7,2.2),new S(pt,-.1,-1.8)]:gt.chapter===2?Jt=[Rt,new S(0,1.1,2.2),new S(-ze*.7,2.5,4),new S(-ze-10,5,0)]:gt.chapter===3?Jt=[Rt,new S(ze*.5,-.6,1.5),jp({small:hn,halfWidth:ze}),Ko({small:hn,halfWidth:ze}).v]:Jt=[Rt,new S(-.5,.8,1),new S(.4,2,E.z-2),new S(ze+9,5,E.z+8)],D={id:gt.id,chapter:gt.chapter,curve:gt.chapter===0?am(Rt,E.z):new kt(Jt),startQ:yn,startScale:V.group.scale.x},ue=gt.chapter,Un&&(gt.chapter===0||gt.chapter===2)&&(Se={started:Y,rows:[]})}let Ht=He(0,1,gt.t),ut=D.curve,Vt=Math.sin(gt.t*Math.PI*2)*.17;V.group.position.copy(ut.getPoint(Ht));let yt=ut.getTangent(Ht),Gt=Ie(yt,Vt);V.group.quaternion.copy(D.startQ).slerp(Gt,He(0,.2,gt.t)),gt.chapter===1&&V.group.quaternion.slerp(new Fe().setFromEuler(v.set(.06,3.5,-.08)),He(.77,1,gt.t)),gt.chapter===3&&V.group.quaternion.slerp(new Fe().setFromEuler(v.set(-.02,-.42,.12)),He(.77,1,gt.t)),V.group.scale.setScalar(bt(D.startScale,je*(gt.chapter===1?.89:1),He(0,.3,gt.t))),gt.chapter===3&&V.group.scale.setScalar(Qp(V.group.scale.x,{small:hn,halfWidth:ze},gt.t)),D.progress=gt.t}else{let Ht=D?.progress===1&&ue===Ot&&Et>=Ot+.14,ut=D?.progress===1&&$p({track:D,chapter:Ot,group:V.group,camera:o,bounds:V.entryBounds,idle:Zt,dt:Ye,small:hn});if(!Ht&&!ut){if(V.group.position.distanceTo(Zt.v)<.45&&V.group.quaternion.angleTo(Zt.q)<.22&&Math.abs(V.group.scale.x-Zt.s)<.08&&!xn){let yt=1-Math.exp(-Math.max(0,Ye)*2.5);V.group.position.lerp(Zt.v,yt),V.group.quaternion.slerp(Zt.q,yt),V.group.scale.lerp(new S(Zt.s,Zt.s,Zt.s),yt)}else xe.update(sn);D=null,ue=-1}}else{let Ht=le.update({returning:he,chapter:Ce,halfWidth:ze,small:hn,anchorY:fe.y,idle:at,dt:Ye,instant:xn});V.group.position.copy(Ht.v),V.group.quaternion.copy(Ht.q),V.group.scale.setScalar(Ht.s)}xe.observe(V.group,Ye),Un&&(xe.active&&!Xe&&(Xe={rows:[]}),Xe&&(Xe.rows.push({time:Y,dt:Ye,stage:xe.stage,destination:Ot,pass:gt?.chapter??null,v:V.group.position.toArray(),q:V.group.quaternion.toArray(),s:V.group.scale.x,outside:Dn(o,V.entryBounds,V.group.position,V.group.quaternion,V.group.scale.x),relocations:xe.relocations}),(!xe.active||Xe.rows.length>=1200)&&(s.dataset.navigationTrace=JSON.stringify(Xe.rows),Xe=null)))}if(Un&&Se&&(Y-Se.started<9&&Se.rows.length<600?Se.rows.push({time:Y,position:Et,chapter:pn,pass:gt?.chapter??null,t:gt?.t??1,v:V.group.position.toArray(),q:V.group.quaternion.toArray(),s:V.group.scale.x,outside:Dn(o,V.entryBounds,V.group.position,V.group.quaternion,V.group.scale.x),parked:!!D?.parked,glide:D?.musicGlide?D.musicGlide.elapsed/D.musicGlide.duration:null}):(s.dataset.passTrace=JSON.stringify(Se.rows),Se=null)),R.visible){Nn.uPhase.value=me,Nn.uFlow.value=C,Nn.uPulse.value=Tn+mn*.3;for(let{line:$e,base:ze}of $){let je=$e.geometry.attributes.position.array;for(let Ce=0;Ce<je.length;Ce+=3)je[Ce]=ze[Ce]*(1-Nn.uCapture.value*.52),je[Ce+2]=ze[Ce+2]+Ho(ze[Ce],ze[Ce+1],me,C,Tn+mn*.3,Nn.uCapture.value);$e.geometry.attributes.position.needsUpdate=!0}Z.update({phase:me,flow:C,capture:Nn.uCapture.value}),B.color.copy(P.color),B.attenuationColor.copy(P.attenuationColor),B.transmission=P.transmission,B.roughness=P.roughness}tt.rotation.z=Y*.025,tt.position.y=-.1;let qe=(.12+Math.sin(Rr(Et,0,5)/5*Math.PI)*.25)*qn*bt(1,.12,U);lt.forEach(($e,ze)=>{$e.material.opacity=qe,$e.rotation.x=.7+ze*.45+Et*.22,$e.scale.setScalar(1+Math.sin(Et*1.6+ze)*.16)}),ne.rotation.z=Y*.012,ne.position.y=Math.sin(Y*.12)*.25,ne.material.color.setHex(U>.5?10201264:5340039),ne.material.opacity=bt(.5,.28,U),re.forEach(($e,ze)=>{let je=$e.userData,Ce=je.a+Y*je.speed;$e.position.set(Math.cos(Ce)*je.r,Math.sin(Ce)*je.r*.7,je.z+Math.sin(Et*.8+ze)*.7),$e.rotation.x=Y*je.speed+ze,$e.rotation.y=Y*je.speed*.6;let pt=k&&z<.75?wr(.3,.7,z):0;pt&&($e.position.x=bt($e.position.x,fe.x,pt),$e.position.y=bt($e.position.y,fe.y,pt),$e.position.z*=1-pt),$e.scale.copy(je.scale).multiplyScalar(bt(1,.42,U)*(1-pt*.96))}),k&&z>=1&&Me===null&&(Me=Y);let Oe=Me===null?0:He(0,.28,he)*Math.exp(-Math.max(0,Y-Me)*2.3),it=1-Rr(Et*1.8,0,1);T.uniforms.uWord.value=it*qn,Re.style.opacity=String(x*it*qn*(.26+Oe*.18)),Ve&&!k?(Yp(i,r,o,V.group),Ve=!1,s.dataset.sharkPrepared="true"):i.render(r,o),Un&&Qi!==null&&Qi>=17.7&&Qi<19.1&&Ne.length<120?Ne.push({audio:Qi,dt:Ye,renderMs:performance.now()-Al,progress:z,phase:me,rawEnergy:Rl,energy:mn,pulse:Tn,scale:w.scale.x,fold:Nn.uCapture.value,camera:o.position.toArray(),wing:Ho(3.15,.15,me,C,Tn+mn*.3,Nn.uCapture.value),position:R.position.toArray(),rotation:w.quaternion.toArray(),programs:i.info.programs.length}):Un&&Qi>=19.1&&Ne.length&&!s.dataset.cueTrace&&(s.dataset.cueTrace=JSON.stringify(Ne)),s.dataset.renderer="webgl",s.dataset.chapter=String(Math.round(Et)),s.dataset.sharkModel=V.model,s.dataset.creature=k&&z>=.63?"shark":k?"attack":"manta",Un&&(s.dataset.mantaRetained=String(R.visible),s.dataset.captureQuality=JSON.stringify({requested:J.requested,applied:J.applied,locked:J.locked,disc:I.transmission,belly:b.transmission,tail:B.transmission}),s.dataset.mantaPose=JSON.stringify({v:R.position.toArray(),q:w.quaternion.toArray(),s:w.scale.x}),s.dataset.arrival=JSON.stringify({complete:le.complete,chapter:le.route?.chapter??null,u:le.route?Math.min(1,le.route.elapsed/le.route.duration):null,v:V.group.position.toArray(),q:V.group.quaternion.toArray(),s:V.group.scale.x}),s.dataset.transit=JSON.stringify({active:xe.active,stage:xe.stage,chapter:xe.chapter,relocations:xe.relocations}),s.dataset.musicGlide=D?.parked?"parked":D?.musicGlide?"glide":"idle",s.dataset.musicGlideProgress=String(D?.musicGlide?D.musicGlide.elapsed/D.musicGlide.duration:0)),s.hasAttribute("data-rhythm-debug")&&(s.dataset.flapBpm=String(50),s.dataset.flapPhase=String(me),s.dataset.sharkPhase=String(nt),s.dataset.jaw=String(V.jawOpen),s.dataset.dark=String(U),s.dataset.sharkX=String(V.group.position.x),s.dataset.sharkEntryWeight=String(Ee?tu(z):0));let ht=V.mouth(o,innerWidth,innerHeight);return ht.x=Rr(ht.x,-innerWidth*.5,innerWidth*1.5),ht.y=Rr(ht.y,-innerHeight*.5,innerHeight*1.5),{mouth:ht,engulfVeil:k?Ae.veil:0}}let se=V.ready.then(()=>i.compileAsync(V.group,o,r)).then(()=>{Ve=!0});return{render:de,resize:Ge,setColor:pe,setLight:ge,ready:se,get arrivalReady(){return le.complete},get navigationBusy(){return xe.active},setAmplitude:Y=>{C=Y},setTransparency:Y=>{Q=Y,P.transmission=ve?bt(.3,.75,Y):bt(.5,.99,Y),P.roughness=bt(.2,.045,Y),I.transmission=bt(.45,.92,Y),b.transmission=bt(.38,.84,Y),V.setFinish(Y)},get light(){return ve},renderer:i}}var rM="./assets/please-lord-seamless.wav";var vl=class{constructor(e,t){this.onChange=e,this.onError=t,this.enabled=!1,this.pending=!1,this.hidden=document.hidden,this.token=0,this.offset=0,this.voice=null}init(){if(this.context)return;let e=window.AudioContext||window.webkitAudioContext;if(!e)throw new Error("Audio is not supported");this.context=new e({latencyHint:"playback"}),this.analyser=this.context.createAnalyser(),this.analyser.fftSize=256,this.analyser.connect(this.context.destination),this.data=new Uint8Array(this.analyser.frequencyBinCount)}async loadBuffer(){return this.buffer?this.buffer:(this.loading||(this.loading=(async()=>{let e=await fetch(rM);if(!e.ok)throw new Error("Audio loop is unavailable");let t=await this.context.decodeAudioData(await e.arrayBuffer());if(!t.length||Math.abs(t.duration-18-38.4)>1/t.sampleRate)throw new Error("Unexpected soundtrack duration");return this.buffer=t,t})().finally(()=>{this.loading=null})),this.loading)}startPlayback(){if(this.voice)return;let e=this.context.createBufferSource(),t=this.context.createGain();e.buffer=this.buffer,e.loop=!0,e.loopStart=18,e.loopEnd=this.buffer.duration,e.connect(t).connect(this.analyser);let n=this.context.currentTime;t.gain.setValueAtTime(0,n),t.gain.linearRampToValueAtTime(.5,n+.15),this.voice={source:e,gain:t,startedAt:n,offset:this.offset},e.onended=()=>{e.disconnect(),t.disconnect()},e.start(n,this.offset)}playbackPosition(e=this.context?.currentTime??0){let t=this.voice?this.voice.offset+Math.max(0,e-this.voice.startedAt):this.offset;if(t<18)return t;let n=this.buffer.duration-18;return 18+(t-18)%n}audiblePosition(e=performance.now()){if(!this.enabled||!this.voice)return null;let t=this.context,n=t.currentTime;if(t.state==="running"){let i=t.getOutputTimestamp?.();i?.contextTime>0&&i?.performanceTime>0?n=Math.min(n,i.contextTime+Math.max(0,e-i.performanceTime)/1e3):n-=Math.max(0,t.outputLatency??t.baseLatency??0)}return this.playbackPosition(Math.max(this.voice.startedAt,n))}stopPlayback(){let e=this.voice;if(!e)return;let t=this.context.currentTime,n=this.context.state==="running"?.04:0;this.offset=this.playbackPosition(t+n),this.voice=null;let i=e.gain.gain;i.cancelAndHoldAtTime?i.cancelAndHoldAtTime(t):(i.cancelScheduledValues(t),i.setValueAtTime(i.value,t)),i.linearRampToValueAtTime(0,t+n),e.source.stop(t+n)}async enable(){if(this.enabled||this.pending)return this.enabled;let e=++this.token;this.pending=!0,this.onChange(!1,!0);try{return this.init(),await Promise.all([this.context.resume(),this.loadBuffer()]),e!==this.token||(this.hidden?await this.context.suspend():this.context.state!=="running"&&await this.context.resume(),e!==this.token)?!1:(this.startPlayback(),this.pending=!1,this.enabled=!0,this.onChange(!0,!1),!0)}catch{return e!==this.token||(this.disable(),this.onError("The soundtrack could not start. Try again or explore in silence.")),!1}}disable(){++this.token,this.pending=!1,this.enabled=!1,this.stopPlayback(),this.onChange(!1,!1)}energy(){if(!this.enabled||!this.analyser||this.hidden)return 0;this.analyser.getByteFrequencyData(this.data);let e=0;for(let t=0;t<32;t++)e+=this.data[t];return Math.min(1,e/3200)}async visibility(e){if(this.hidden=e,!!this.context)try{e?await this.context.suspend():this.enabled&&await this.context.resume()}catch{this.enabled&&this.disable()}}};var oM=1.2*3,aM=1.2*4,Ml=()=>({x:0,y:0,z:0,rx:0,ry:0,rz:0,scale:1});function Hu(s,e="roll"){let t=Math.max(0,Math.min(1,s));if(t===0||t===1)return Ml();let n=He(0,1,t),i=Math.sin(Math.PI*n)**2;return e==="dive"?{x:-.5*Math.sin(In*n)*i,y:-.68*i,z:-.95*i,rx:-.38*Math.sin(In*n)*i,ry:-In*n,rz:.36*Math.sin(Math.PI*n)*i,scale:1-.12*i}:{x:.45*Math.sin(In*n)*i,y:.48*i,z:-.65*i,rx:.24*Math.sin(In*n)*i,ry:In*n,rz:-.22*Math.sin(Math.PI*n)*i,scale:1-.08*i}}var Sl=class{constructor(){this.elapsed=null,this.pose=Ml(),this.kind="roll"}get active(){return this.elapsed!==null}get duration(){return this.kind==="dive"?aM:oM}get progress(){return this.active?Math.min(1,this.elapsed/this.duration):0}start(e=!0,t="roll"){return!e||this.active?!1:(this.kind=t==="dive"?"dive":"roll",this.elapsed=0,this.pose=Ml(),!0)}reset(){return this.elapsed=null,this.pose=Ml()}update(e,{paused:t=!1,reduced:n=!1}={}){if(n)return this.reset();if(t||!this.active)return this.pose;let i=Math.max(0,Number.isFinite(e)?e:0);return this.elapsed+=i,this.elapsed>=this.duration-1e-9?this.reset():this.pose=Hu(this.progress,this.kind)}};var bl=class{constructor(e){this.words=[],this.held=!1,e.forEach((t,n)=>{let i=[];for(let r of t.querySelectorAll("h2,.body-copy,.margin-note")){let o=document.createTreeWalker(r,NodeFilter.SHOW_TEXT),a=[];for(;o.nextNode();)o.currentNode.parentElement.closest("a,button")||a.push(o.currentNode);for(let c of a){let l=document.createDocumentFragment();for(let h of c.textContent.split(/(\s+)/)){if(!h)continue;if(/^\s+$/.test(h)){l.append(document.createTextNode(h));continue}let u=document.createElement("span");u.className="edible-word",u.textContent=h,l.append(u),i.push({el:u,chapter:n,amount:0,x:0,y:0})}c.replaceWith(l)}}i.forEach((r,o)=>{r.index=o,r.count=i.length,this.words.push(r)})}),this.measure()}measure(){for(let e of this.words)e.el.style.transform="none";for(let e of this.words){let t=e.el.getBoundingClientRect();e.x=t.x+t.width/2,e.y=t.y+t.height/2}}prepare(e,t,{still:n=!1}={}){for(let i of this.words)i.amount=t&&!this.held&&!n?Dp(e,i.chapter,i.index,i.count):0}render(e,t=!1){let n=0;for(let i of this.words){let r=e&&!t?i.amount:0;i.el.style.opacity=String(1-r),i.el.style.transform=t||r===0||r===1?"none":`translate(${(e.x-i.x)*r}px,${(e.y-i.y)*r}px) rotate(${(i.index%2?1:-1)*r*26}deg) scale(${1-r*.93})`,i.el.style.filter=t||r===0||r===1?"none":`blur(${r*1.1}px)`,r===1&&n++}return n}};var hm=3.6,El=class{constructor(){this.position=0,this.target=0,this.reverseDistance=0,this.redirecting=!1,this.quiet=0,this.done=new Set,this.pass=null,this.serial=0}update(e,t,{active:n=!0,paused:i=!1,reduced:r=!1,target:o=e,busy:a=!1}={}){let c=e-this.position,l=Math.min(4,Math.floor(e)),h=e-l,u=o-this.target;if(u<-.001)for(let m of this.done)m>=l&&this.done.delete(m);if(!n||r)return this.pass=null,this.position=e,this.target=o,this.reverseDistance=0,this.redirecting=!1,null;if(i)return this.pass?{...this.pass}:null;let d=!this.pass&&!a&&this.position<.14&&!this.done.has(0)&&c>1e-5&&o>=.14;return this.pass?.chapter===0||d?(this.redirecting=!1,this.reverseDistance=0,this.quiet=0,d&&e<.14?(this.position=e,this.target=o,null):(this.done.add(0),d?this.pass={id:++this.serial,chapter:0,t:0}:this.pass.t<1?this.pass.t=Ls(this.pass.t+Math.max(0,Math.min(t,.1))/hm):(this.pass=null,o<.14&&this.done.delete(0),this.redirecting=o<.14||o>=1.735),this.position=e,this.target=o,this.pass?{...this.pass}:null)):(this.reverseDistance=u<0?this.reverseDistance-u:u>.001?0:this.reverseDistance,(this.reverseDistance>.08||Math.abs(u)>1.1||Math.abs(o-e)>1.25||this.pass&&o>this.pass.chapter+1.1||a)&&(this.pass=null,this.redirecting=!0,this.quiet=0,this.reverseDistance=0),this.redirecting?(this.done.add(l),this.quiet=a||Math.abs(u)>.001||Math.abs(e-o)>.01?0:this.quiet+Math.min(t,.1),this.quiet>.18&&(this.redirecting=!1,h<.14&&this.done.delete(l)),this.position=e,this.target=o,null):(i||(this.pass&&(this.pass.t>=1?this.pass=null:this.pass.t=Ls(this.pass.t+Math.max(0,Math.min(t,.1))/hm)),!this.pass&&c>1e-5&&h>=.14&&h<.84&&!this.done.has(l)&&(this.done.add(l),this.pass={id:++this.serial,chapter:l,t:0})),this.position=e,this.target=o,this.pass?{...this.pass}:null))}};var ce=s=>document.querySelector(s),Ds=(s,e=0,t=1)=>Math.max(e,Math.min(t,s)),lM=s=>s*s*(3-2*s),_m=matchMedia("(prefers-reduced-motion: reduce)"),Xn=new URLSearchParams(location.search),hM=new el,dm=new El,Cr=Xn.has("debug-rhythm"),Ii=new Sl,fm=new gl;Cr&&(ce("#world").dataset.rhythmDebug="");var dt=_m.matches||Xn.has("reduced"),At=dt,nn=!1,$i=0,Wn=0,Pi=0,pm=0,Xu=0,qu=-1,Pr=0,Yu=0,Lr=0,Yt=!0,Vu=0,Gu=0,Ns=[...document.querySelectorAll(".chapter")],Ku=Ns.map(s=>s.querySelector(".panel")),Ir=new hl(18),Li=new bl(Ku),It=Ir.snapshot(),mm=!1,uM=["HOME","ARTIST","LISTEN","FINAL BOUNCE","INSTAGRAM","CONTACT"],Di=[],Jo={x:0,y:0},Nr={x:0,y:0},Tl=ce(".entry"),Zu=[ce("#enter-sound"),ce("#enter-quiet")];ce(".nav").inert=!0;ce("#journey").inert=!0;var gm;function xm(s){ce(".status-message").textContent=s,ce(".status-message").classList.add("visible"),clearTimeout(gm),gm=setTimeout(()=>ce(".status-message").classList.remove("visible"),5e3)}function dM(s,e=!1){document.body.classList.toggle("sound-on",s),ce("#sound-toggle").setAttribute("aria-pressed",String(s)),ce("#sound-toggle").setAttribute("aria-busy",String(e)),ce("#sound-toggle").setAttribute("aria-label",e?"Cancel audio loading":s?"Mute sound":"Enable sound"),ce(".sound-label").textContent=e?"LOADING\u2026":s?"SOUND ON":"SOUND OFF"}var Ni=new vl(dM,xm);function ym(){ce(".ready-label").textContent="READY TO EXPLORE",ce(".ready-state .ui-arrow").removeAttribute("hidden")}function Wu(){document.body.classList.add("no-webgl"),ce("#world").dataset.renderer="fallback",ym()}var fM=Np(ce(".wordmark"),()=>{Yt=!0}),Ft=null;if(Xn.has("fallback"))Wu();else try{Ft=cm(ce("#world"),{mobile:innerWidth<=800||navigator.connection?.saveData,onFallback:Wu,wordmarkArt:fM})}catch(s){console.warn("Manta fallback:",s),Wu()}ym();Ft?.ready.then(()=>{Yt=!0});Ft?.light&&ce("#light-mode").setAttribute("aria-pressed","true");ce("#light-mode span").textContent=Ft?.light?"ON":"OFF";function Ju(){let s=nn&&Di.length>0,e=Pi;if(Di=Ns.map(t=>t.offsetTop),Ft?.resize(),s){let t=Math.min(4,Math.floor(e));scrollTo({top:Di[t]+(Di[t+1]-Di[t])*(e-t),behavior:"instant"})}$u(),Li.measure(),Yt=!0}function $u(){let s=0;for(;s<5&&scrollY>=Di[s+1];)s++;Pi=Math.min(5,s+(s<5?(scrollY-Di[s])/(Di[s+1]-Di[s]):0)),(dt||At)&&(Wn=Pi),Yt=!0}function wl(s=!1){ce("#index-panel").hidden=!0,ce(".index-toggle").setAttribute("aria-expanded","false"),s&&ce(".index-toggle").focus()}function $o(s=!1){ce("#customizer").hidden=!0,ce("#customize-toggle").setAttribute("aria-expanded","false"),s&&ce("#customize-toggle").focus()}function ju(s){if(nn)return;nn=!0,s&&Ni.enable(),Tl.classList.add("is-closed"),Tl.inert=!0,Tl.setAttribute("aria-hidden","true"),document.body.classList.remove("awaiting-entry"),ce(".nav").inert=!1,ce("#journey").inert=!1,ce(".hud").inert=!1,Ju();let t={"#production":"#label","#projets":"#instagram"}[location.hash]||location.hash,n=Ns.find(i=>"#"+i.id===t)||Ns[0];scrollTo({top:n.offsetTop,behavior:"instant"}),$u(),Wn=Pi,dt&&($i=1),document.documentElement.classList.add("journey-snap"),Ii.start(!!Ft&&!document.body.classList.contains("no-webgl")&&!At&&!dt),ce("#sound-toggle").focus({preventScroll:!0}),Yt=!0}ce("#enter-sound").addEventListener("click",()=>ju(!0));ce("#enter-quiet").addEventListener("click",()=>ju(!1));Tl.addEventListener("keydown",s=>{s.key==="Tab"&&(s.preventDefault(),Zu[document.activeElement===Zu[0]?1:0].focus())});Zu[0].focus({preventScroll:!0});function pM(){Ni.enabled||Ni.pending?Ni.disable():Ni.enable()}ce("#sound-toggle").addEventListener("click",pM);ce("#text-toggle").addEventListener("click",()=>{Li.held=!Li.held,ce("#text-toggle").setAttribute("aria-pressed",String(Li.held)),ce("#text-toggle").setAttribute("aria-label",Li.held?"Restore word aspiration":"Keep all text visible"),ce("#text-toggle").textContent=Li.held?"TEXT HELD":"KEEP TEXT",Yt=!0});document.querySelectorAll(".platform-links a").forEach(s=>s.addEventListener("click",()=>Ni.disable()));function vm(){nn&&(Xu=1,Yt=!0)}ce("#pulse").addEventListener("click",()=>{let s=nn&&!!Ft&&!document.body.classList.contains("no-webgl")&&!It.active&&!At&&!dt;Ii.start(s)&&(Yt=!0)});var Dr;ce("#world").addEventListener("pointerdown",s=>{Dr={x:s.clientX,y:s.clientY}});ce("#world").addEventListener("pointerup",s=>{Dr&&Math.hypot(s.clientX-Dr.x,s.clientY-Dr.y)<12&&vm(),Dr=null});ce("#world").addEventListener("pointercancel",()=>Dr=null);addEventListener("pointermove",s=>{if(s.pointerType==="touch")return;Nr.x=(s.clientX/innerWidth-.5)*2,Nr.y=-(s.clientY/innerHeight-.5)*2;let e=ce(".cursor-orbit");e.style.left=s.clientX-21+"px",e.style.top=s.clientY-21+"px",e.style.opacity=nn&&s.target===ce("#world")&&!dt?"1":"0",Yt=!0},{passive:!0});document.addEventListener("pointerleave",()=>{Nr.x=Nr.y=0,ce(".cursor-orbit").style.opacity=0});ce(".index-toggle").addEventListener("click",()=>{let s=!ce("#index-panel").hidden;$o(),ce("#index-panel").hidden=s,ce(".index-toggle").setAttribute("aria-expanded",String(!s))});document.querySelectorAll('a[href^="#"]').forEach(s=>s.addEventListener("click",()=>{wl(),$o(),nn||ju(!1)}));ce("#customize-toggle").addEventListener("click",()=>{let s=!ce("#customizer").hidden;wl(),ce("#customizer").hidden=s,ce("#customize-toggle").setAttribute("aria-expanded",String(!s))});ce("#customize-close").addEventListener("click",()=>$o(!0));document.addEventListener("keydown",s=>{s.key==="Escape"&&(wl(),$o())});document.addEventListener("click",s=>{s.target.closest(".index-panel,.index-toggle")||wl(),s.target.closest(".customizer,#customize-toggle")||$o()});document.querySelectorAll("[data-color]").forEach(s=>s.addEventListener("click",()=>{document.querySelectorAll("[data-color]").forEach(e=>e.setAttribute("aria-pressed",String(e===s))),Ft?.setColor(s.dataset.color),ce(".fallback-creature").style.filter=s.dataset.color==="iris"?"hue-rotate(75deg)":s.dataset.color==="ember"?"hue-rotate(185deg)":"none",Yt=!0,vm()}));ce("#fluidity").addEventListener("input",s=>{Ft?.setAmplitude(Number(s.target.value)/100),ce("#fluidity-value").textContent=s.target.value+"%",Yt=!0});ce("#glass").addEventListener("input",s=>{Ft?.setTransparency(Number(s.target.value)/100),ce("#glass-value").textContent=s.target.value+"%",Yt=!0});function Mm(s,e=!1){Ft?.setLight(s),ce("#light-mode").setAttribute("aria-pressed",String(s)),ce("#light-mode span").textContent=s?"ON":"OFF",Yt=!0,e&&xm("Switched to lightweight mode to keep things fluid.")}ce("#light-mode").addEventListener("click",()=>Mm(!Ft?.light));function Qu(){Lr=performance.now(),document.body.classList.toggle("is-paused",At),document.body.classList.toggle("reduced-motion",dt),ce("#motion-toggle").setAttribute("aria-pressed",String(At)),ce("#motion-toggle").setAttribute("aria-label",At?"Resume animation":"Pause animation"),ce("#motion-toggle").textContent=At?"\u25B7":"\u2161",Yt=!0}ce("#motion-toggle").addEventListener("click",()=>{At=!At,Qu()});_m.addEventListener("change",s=>{dt=s.matches,At=dt,Qu()});Qu();function mM(s){let e=Math.min(4,Math.floor(s)),t=s-e,n=lM(Ds((t-.52)/.43)),i=Ku.map((o,a)=>a===e?1-n:a===e+1?n:0),r=s>=4.95?5:n>.5?e+1:e;Ku.forEach((o,a)=>{let c=nn?i[a]*$i:0;o.style.opacity=c.toFixed(3),o.style.visibility=c>.01?"visible":"hidden",o.style.transform=dt?"none":`translateY(${(1-c)*(a<=e?-18:22)}px)`,Ns[a].inert=!nn||a!==r,Ns[a].setAttribute("aria-hidden",String(!nn||a!==r))}),r!==qu&&(qu=r,ce("#chapter-label").textContent=String(r).padStart(2,"0")+" / "+uM[r],ce(".scroll-next").href="#"+Ns[Math.min(5,r+1)].id,ce(".scroll-label").textContent=r===5?"BACK UP":"SCROLL",ce(".scroll-direction .ui-arrow path").setAttribute("d",r===5?"M12 21V3m-7 7 7-7 7 7":"M12 3v18m-7-7 7 7 7-7"),r===5&&(ce(".scroll-next").href="#top")),ce(".scroll-line i").style.width=Ds(s/5)*100+"%",Ft||(ce(".wordmark").style.opacity=(1-Ds(s*1.7))*$i*.8,ce(".fallback-creature").style.transform=`translate(-50%, -50%) rotate(${s*8-8}deg) scale(${.85+Math.sin(s)*.1})`)}function ed(s){Pr=requestAnimationFrame(ed);let e=Math.min(.05,(s-Yu)/1e3||.016);Yu=s;let t=Ft?.light?30:60;if(s-Lr<1e3/t-1)return;let n=Ni.audiblePosition(s),i=It;if(It=Ir.update(n,nn,dt||At),nn&&$i>.995&&Xn.has("preview-takeover")){let T=Number(Xn.get("preview-takeover"));Number.isFinite(T)&&(Ir.active=!0,Ir.progress=Ds(T),Ir.elapsed=T<1?Ds(T)*3:3+Ds(Number(Xn.get("preview-return")??1))*2.4,It=Ir.snapshot())}(i.active!==It.active||i.progress!==It.progress)&&(Yt=!0),Op(It)&&!mm&&(mm=!0,document.body.classList.add("shark-ui-ready"),ce('meta[name="theme-color"]').content="#090c10",ce("#text-toggle").disabled=!1,ce("#text-toggle").inert=!1,ce("#text-toggle").removeAttribute("aria-hidden"),ce(".specimen-note span").textContent="SHARK / 002",ce(".customizer-top>span").textContent="YOUR SHARK",ce('label[for="glass"]').firstChild.textContent="Surface sheen ",ce("#customizer").setAttribute("aria-label","Shape the shark"),ce("#scene-announcement").textContent="The shark takes over. Listening links and navigation remain available. Use Keep text to preserve all editorial text."),document.body.classList.toggle("is-abyss",It.dark>.48),document.body.style.setProperty("--abyss-progress",String(It.dark));let r=It.active&&It.swallowed>=.99,o=r?"shark":"manta";ce("#world").dataset.animal!==o&&(ce("#world").dataset.animal=o,ce("#world").setAttribute("aria-label",r?"An animated glass shark, OKARAR\u2019s nocturnal totem":"An animated glass manta ray, OKARAR\u2019s totem"),ce(".fallback-creature").src=`./assets/${o}-fallback.svg`,ce(".fallback-creature").alt=r?"A glass shark in dark water":"Translucent manta ray"),document.body.dataset.scene=It.active?It.progress<1?"attack":"shark":"manta",ce("#pulse").hidden=It.active||At||dt,Cr&&(ce("#world").dataset.takeoverProgress=String(It.progress));let a=Math.abs(Wn-Pi)<.001&&(!nn||$i>.999);if((At||dt)&&!Yt&&a)return;let c=Lr?s-Lr:16;Lr=s,!At&&!dt&&(pm+=c/1e3);let l=1-Math.exp(-e*8);Wn+=(Pi-Wn)*(dt?1:l),$i+=(Number(nn)-$i)*(dt?1:l),Jo.x+=(Nr.x-Jo.x)*l,Jo.y+=(Nr.y-Jo.y)*l,!At&&!dt&&(Xu*=.94);let h=Ni.energy(),u=hM.update(c/1e3,n,At||dt);fm.update(Ii,{position:Wn,target:Pi,delta:c/1e3,allowed:nn&&!!Ft&&!document.body.classList.contains("no-webgl")&&!It.active&&!At&&!dt});let d=Ii.update(c/1e3,{paused:At,reduced:dt});if(nn&&!It.active&&!At&&!dt&&Xn.has("preview-flourish")){let T=Number(Xn.get("preview-flourish"));Number.isFinite(T)&&(d=Hu(T,Xn.get("preview-figure")||"roll"))}ce("#pulse").disabled=Ii.active,ce("#pulse").setAttribute("aria-busy",String(Ii.active)),Cr&&(ce("#world").dataset.flourishProgress=String(Ii.progress),ce("#world").dataset.flourishActive=String(Ii.active),ce("#world").dataset.flourishKind=Ii.kind,ce("#world").dataset.divePlayed=String(fm.divePlayed)),Cr&&(ce("#world").dataset.audioPosition=n===null?"silent":String(n),ce("#world").dataset.motionFrozen=String(At||dt));let f=!!Ft&&!document.body.classList.contains("no-webgl"),m=It.active&&It.returning>=1&&f;Li.prepare(Wn,m,{still:dt||!f});let _=dm.update(Wn,c/1e3,{active:m&&Ft.arrivalReady,paused:At,reduced:dt,target:Pi,busy:Ft?.navigationBusy});m&&Ft.arrivalReady&&!dt&&Xn.has("preview-pass")&&(_={id:"preview",chapter:Math.min(4,Math.floor(Wn)),t:Ds(Number(Xn.get("preview-pass")))}),mM(Wn),Cr&&(ce("#world").dataset.sharkBpm="50"),document.body.classList.toggle("is-passing",!!_),document.body.classList.toggle("is-engulfing",f&&!dt&&It.active&&It.progress>=.4&&It.progress<1);let g=Ft?.render({time:dt?1.1:pm,phase:u,sharkPhase:u,dt:At||dt?0:c/1e3,position:Wn,targetPosition:Pi,redirecting:dm.redirecting,displayChapter:qu,entered:$i,pointer:dt?{x:0,y:0}:Jo,pulse:Xu,energy:h,reduced:dt||At,paused:At,takeover:It,pass:_,flourish:d,audioPosition:n}),p=Li.render(g?.mouth,dt||!f);document.body.style.setProperty("--engulf-veil",String(dt?0:g?.engulfVeil||0)),Cr&&(ce("#world").dataset.eatenWords=String(p),ce("#world").dataset.pass=_?String(_.chapter):"idle",ce("#world").dataset.passProgress=String(_?.t??0),ce("#world").dataset.mouth=JSON.stringify(g?.mouth)),!Ft?.light&&!At&&!dt&&nn&&(Gu++,c>36&&Vu++,Gu===150&&(Vu>65&&Mm(!0,!0),Gu=Vu=0)),Yt=!1}addEventListener("scroll",$u,{passive:!0});addEventListener("resize",Ju,{passive:!0});document.addEventListener("visibilitychange",()=>{Ni.visibility(document.hidden),document.hidden?(cancelAnimationFrame(Pr),Pr=0):(Yu=Lr=performance.now(),Yt=!0,Pr||(Pr=requestAnimationFrame(ed)))});Ju();Pr=requestAnimationFrame(ed);document.fonts.ready.then(()=>{Li.measure(),Yt=!0});})();
